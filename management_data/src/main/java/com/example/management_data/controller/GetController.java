package com.example.management_data.controller;

import com.example.management_data.config.TestConfig;
import com.example.management_data.dto.MemberDTO;
...
public class GetController {
    ...
    @Autowired
    GetController(TestConfig testConfig) {
        this.testConfig = testConfig;
    }


    // http://localhost:8080/api/v1/resource/properties
    ...
    public Map<String, String> selectBoard(@RequestParam String no) {
